(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,87154,e=>{"use strict";var s=e.i(43476),r=e.i(71645);e.s(["default",0,({state:e="idle",size:t=200,className:i="",onClick:a})=>{let o=(0,r.useCallback)(()=>`mf-${e}`,[e]);return(0,s.jsxs)("div",{className:`moose-wrapper ${i}`,style:{width:t,height:t},onClick:a,children:[(0,s.jsx)("style",{children:`
        .moose-wrapper {
          position: relative;
          cursor: pointer;
        }
