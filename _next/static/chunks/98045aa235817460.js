(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,52683,e=>{"use strict";var s=e.i(43476),t=e.i(71645);let r=({state:e="idle",size:r=200,className:a="",onClick:i})=>{let o=(0,t.useCallback)(()=>`mf-${e}`,[e]);return(0,s.jsxs)("div",{className:`moose-wrapper ${a}`,style:{width:r,height:r},onClick:i,children:[(0,s.jsx)("style",{children:`
        .moose-wrapper {
          position: relative;
          cursor: pointer;
        }
